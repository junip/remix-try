...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-try-2f7b
  fly apps create remix-try-2f7b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-try-2f7b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-try-2f7b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-try-2f7b-staging' does not match app name in config file 'remix-try-2f7b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-try-2f7b-db
  fly postgres attach --app remix-try-2f7b remix-try-2f7b-db

  fly postgres create --name remix-try-2f7b-staging-db
  fly postgres attach --app remix-try-2f7b-staging remix-try-2f7b-staging-db
  ```
